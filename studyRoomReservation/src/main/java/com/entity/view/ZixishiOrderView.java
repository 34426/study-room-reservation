...
public class ZixishiOrderView extends ZixishiOrderEntity implements Serializable {
	...
	*/
	...
	private String zixishiOrderValue;
	...
	public ZixishiOrderView() {

	}

	public ZixishiOrderView(ZixishiOrderEntity zixishiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, zixishiOrderEntity);
	...
	* 获取： 预约类型的值
	*/
	public String getZixishiOrderValue() {
		return zixishiOrderValue;
	}
	/**
	* 设置： 预约类型的值
	*/
	public void setZixishiOrderValue(String zixishiOrderValue) {
		this.zixishiOrderValue = zixishiOrderValue;
	}
	...
	public String toString() {
		return "ZixishiOrderView{" +
			", zixishiOrderValue=" + zixishiOrderValue +
