...
public class ZixishiLiuyanView extends ZixishiLiuyanEntity implements Serializable {
	...
	public ZixishiLiuyanView() {

	}

	public ZixishiLiuyanView(ZixishiLiuyanEntity zixishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, zixishiLiuyanEntity);
